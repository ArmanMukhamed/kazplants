...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        demo_products = [
            ...
            ("Подарочный сет Green", "podarochnyy-set-green", "Готовые решения", "Набор из растения и кашпо.", "in_stock", 50, 25, "Казахстан", "easy", "Рассеянный", "1-2 раза в неделю", Decimal("17900.00"), False, True),
